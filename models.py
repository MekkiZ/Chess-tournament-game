class Tournament:
    def __init__(self, name, place, date, time, round_tourne, description, nb_tour=4):
        ...
        self.time = time
        self.round_tourne = round_tourne
...
class Player:
    def __init__(self, nom, prenom, date_de_naissance, sexe, rank):
        self.nom = nom
        self.prenom = prenom
    ...
    def __str__(self):
        return f"{self.nom}, {self.prenom}, {self.date_de_naissance},{ self.sexe}, {self.rank}"
    def __repr__(self):
        return f"{self.nom}, {self.prenom}, {self.date_de_naissance},{ self.sexe}, {self.rank}"
